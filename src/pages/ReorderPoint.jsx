            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <div className="flex flex-wrap sm:flex-nowrap gap-3 w-full md:w-auto">
                    <Button 
                        ...
                        className="flex items-center gap-2 shadow-lg shadow-emerald-100 flex-1 sm:flex-none"
                        loading={isExporting}
                    >
                        <Download size={18} />
                    ...
                    <div className="relative flex-1 sm:flex-none min-w-[150px]">
                        ...
                        <input
                            ...
                            className="pl-10 pr-4 py-2 bg-white border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-indigo-500 outline-none w-full sm:w-48 shadow-sm transition-all"
                            value={searchTerm}
                    ...
                    >
                        <Settings2 size={18} />
                        <span className="whitespace-nowrap">{editMode ? 'Exit Plan' : 'Planning'}</span>
                    </Button>
                </div>
            </div>
